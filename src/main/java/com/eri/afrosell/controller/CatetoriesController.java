...
import com.eri.afrosell.model.CreateCategoryRequestModel;
import com.eri.afrosell.model.UpdateCategoryRequestModel;
...
import com.eri.afrosell.service.categories.CategoriesService;
...
@RestController
@RequestMapping(APINames.CATEGORIES_API)
public class CatetoriesController  {
    ...
    @RequestMapping(path = APINames.CATEGORIES_ADD, method = RequestMethod.POST)
    ...
    @RequestMapping(path = APINames.CATEGORIES_UPDATE, method = RequestMethod.POST)
    ...
    @RequestMapping(value = APINames.CATEGORIES_DELETE, method = RequestMethod.POST, produces = APINames.CHARSET)
    ...
    @RequestMapping(value = APINames.CATEGORIES_LIST, method = RequestMethod.GET, produces = APINames.CHARSET)
    ...
    @RequestMapping(value = APINames.CATEGORIES_DETAIL, method = RequestMethod.GET, produces = APINames.CHARSET)
    public ResponseEntity<APIResponse> deleteCategory(
            @PathVariable(value = "company_id") long companyId,
